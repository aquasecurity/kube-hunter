...
parser.add_argument('--infrastructure-check', action="store_true", default=True, help="set whether to check if the cluster is deployed on azure cloud - defaults to true | options: True, False")
