...
def parse_args():
    parser = ArgumentParser(description='Kube-Hunter - hunts for security '
                                        'weaknesses in Kubernetes clusters')

    parser.add_argument('--list', action="store_true",
                        help="Displays all tests in kubehunter (add --active "
                             "flag to see active tests)")
    ...
    parser.add_argument('--include-patched-versions', action="store_true",
    ...
    parser.add_argument('--remote', nargs='+', metavar="HOST", default=list(),
    ...
    parser.add_argument('--log', type=str, metavar="LOGLEVEL", default='INFO',
                        help="Set log level, options are: debug, info, warn, "
                             "none")

    parser.add_argument('--report', type=str, default='plain',
    ...
    parser.add_argument('--dispatch', type=str, default='stdout',
                        help="Where to send the report to, options are: "
                             "stdout, http (set KUBEHUNTER_HTTP_DISPATCH_URL "
                             "and "
                             "KUBEHUNTER_HTTP_DISPATCH_METHOD environment "
                             "variables "
                             "to configure)")
