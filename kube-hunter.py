...
parser.add_argument(
    "--interface", action="store_true", help="set hunting of all network interfaces"
)
...
parser.add_argument(
    "--ignore-downstream",
    action="store_true",
    help="Ignore patched kubernetes versions",
)
parser.add_argument(
...
reporters = {"yaml": YAMLReporter, "json": JSONReporter, "plain": PlainReporter}
...
dispatchers = {"stdout": STDOUTDispatcher, "http": HTTPDispatcher}
