...
parser.add_argument('--dispatch', type=str, default='stdout', help="where to send the report to, options are: stdout, http (use KUBEHUNTER_DISPATCH_URL and KUBEHUNTER_DISPATCH_METHOD to configure)")
